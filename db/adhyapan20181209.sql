...
CREATE TABLE `class` (
  ...
  CONSTRAINT `fk_center_id` FOREIGN KEY (`center_id`) REFERENCES `center` (`id`) ON DELETE SET NULL ON UPDATE CASCADE,
  CONSTRAINT `fk_standard_id` FOREIGN KEY (`standard_id`) REFERENCES `standard` (`id`) ON DELETE SET NULL ON UPDATE CASCADE,
  CONSTRAINT `fk_subject_id` FOREIGN KEY (`subject_id`) REFERENCES `subject` (`id`) ON DELETE SET NULL ON UPDATE CASCADE,
  CONSTRAINT `fk_teacher_id` FOREIGN KEY (`teacher_id`) REFERENCES `teacher` (`id`) ON DELETE SET NULL ON UPDATE CASCADE
...
INSERT INTO `student` VALUES (1,'ANIKT','Anik','Talukder',1,'9632587410','Sudhir Talukder','9876643210','Garia','M','2018-12-07 14:27:43',NULL,'2018-12-07 14:27:43'),(2,'RAHULDAS','Rahul','Das',4,'9632587410','SK Das','9856321470','Rabindranagar','M','2018-12-07 14:58:18',NULL,'2018-12-07 14:58:18'),(3,'JOYDAS','Joyantee','Das',3,'9632587410','A C Das','9874563210','Garia','F','2018-12-07 15:00:35',NULL,'2018-12-07 15:00:35'),(4,'SAYALMOINTA','Sayak','Mohinta',2,'9876543212','S Mohinta','9876543211','Garia','M','2018-12-09 14:18:04',NULL,'2018-12-09 14:18:04');
...
INSERT INTO `teacher` VALUES (2,'Sajal','Guha','SKG','9876543210','Naktala',1,3,'2018-12-06 00:00:00',NULL,'2018-12-06 00:00:00'),(3,'Shibaji','Chakraborty','SC','9874563210','Dhakuria',1,2,NULL,NULL,NULL),(4,'Partha','Chakraborty','PSC','9856321470','Gariahat',2,1,'2018-12-07 12:51:39',NULL,'2018-12-07 12:51:39'),(5,'Kaushik','Talukder','KT','9876543210','Mahamayatala',5,8,'2018-12-07 12:53:08',NULL,'2018-12-07 12:53:08');
...
-- Dump completed on 2018-12-09 14:19:57
